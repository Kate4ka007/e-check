...
export const ru = {
  ...
  'landing.seo.title': 'Чеки — учёт расходов по фото чека',
  'landing.seo.description':
    'Сфотографируйте чек — мы разберём магазин, дату, позиции и итог. Проверьте данные и ведите расходы в одном месте.',
  ...
  'demo.seo.description':
    'Посмотрите, как выглядит проверка распознанного чека: правка полей, сверка сумм и позиции. Учебный пример, данные не сохраняются.',
